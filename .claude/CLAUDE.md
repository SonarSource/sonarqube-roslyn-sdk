...
```bash
sonar analyze agentic --project sonarqube-roslyn-sdk --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project sonarqube-roslyn-sdk --depth DEEP
```
