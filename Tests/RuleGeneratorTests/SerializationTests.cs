    ...
    <status>READY</status>
        ...
        public void RulesMustHaveDescription()
        {
            ...
            rules.Add(new Rule()
            {
                ...
                InternalKey = "internalKey1",
                Name = "Rule1",
                Description = "This rule has a description.", // Should be no change if a rule already has a description
                Severity = "INFO",
                Cardinality = "SINGLE",
                Status = "READY",
            });
            ...
            rules.Add(new Rule()
            {
                ...
                InternalKey = "internalKey2",
                Name = "Rule2",
                Description = null, // Should be replaced with a placeholder
                Severity = "INFO",
                Cardinality = "SINGLE",
                Status = "READY",
            });
            ...
            rules.Add(new Rule()
            {
                ...
                Name = "Rule3",
                Description = "", // Should be replaced with a placeholder
                Severity = "MAJOR",
                Cardinality = "SINGLE",
                Status = "READY",
            });
...
<rules xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  <rule>
    ...
    <name>Rule1</name>
    <internalKey>internalKey1</internalKey>
    <description><![CDATA[This rule has a description.]]></description>
  ...
  <rule>
    ...
    <name>Rule2</name>
    <internalKey>internalKey2</internalKey>
    <description><![CDATA[This rule does not have a description.]]></description>
    <severity>INFO</severity>
    <cardinality>SINGLE</cardinality>
    <status>READY</status>
  </rule>
  <rule>
    <key>key3</key>
    <name>Rule3</name>
    <internalKey>internalKey3</internalKey>
    <description><![CDATA[This rule does not have a description.]]></description>
    <severity>MAJOR</severity>
    <cardinality>SINGLE</cardinality>
    <status>READY</status>
